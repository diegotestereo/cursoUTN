...
public class lay_login extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		{			
			...
			{
				Toast.makeText(lay_login.this, getString(R.string.hello_world), Toast.LENGTH_SHORT).show();				
			}
		});
	}	
		...
		button_login.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				if (validacion.length() == 0)
				{
					...
					intento.putExtra(getResources().getString(R.string.hello_world), edit_user.getText().toString());
